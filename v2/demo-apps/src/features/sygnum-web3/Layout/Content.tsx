  ...
  return (
    <main>
      <section
        ...
        style={{
          backgroundImage:
            "url(https://www.sygnum.com/wp-content/uploads/2022/06/Sygnum-sphere-scarce-altcoins-016-1.jpg)",
        }}
      >
        <div className="banner__wrapper">
          ...
          <p className="banner__description">
            Welcome to the world’s first digital asset bank, founded on Swiss
            and Singapore heritage. Our mission is to empower everyone,
            everywhere, to own crypto with complete trust. Onboard with Sygnum
            today to buy, trade and earn crypto to future-proof your investment
            strategy.
          </p>
          <a
            href="#"
            className="btn banner__btn btn--large btn--red"
            target="_self"
        ...
        <div className="charts__wrapper">
          <div className="charts__inner">
            <div className="swiper chart-swiper swiper-initialized swiper-horizontal swiper-pointer-events">
              <div className="swiper-wrapper chart-swiper-wrapper">
                <div
                  id="bitcoin"
                  className="chart-swiper-slide chart swiper-slide swiper-slide-duplicate"
                  data-swiper-slide-index={0}
                  style={{ marginRight: "32px" }}
                >
                  <a
                    href="https://www.sygnum.com/digital-asset-banking/bitcoin-btc/"
                    className="link--absolute chart__coin-link"
                  >
                    <div className="chart__price">
                      <div className="chart__title-wrapper">
                        <div className="chart__ico-wrapper">
                          <img
                            ...
                            className="chart__ico wp-post-image"
                            alt="Bitcoin"
                          />{" "}
                        </div>
                      ...
                      <div className="chart__price-wrapper">
                        ...
                        <div className="chart__change-wrapper">
                          <span
                            className="chart__change"
                            style={{
                              background:
                                'url("/icons/price_change_down.svg") center center no-repeat',
                            }}
                          />
                          <span
                            className="chart__changes-percent--hour"
                            style={{ color: "rgb(236, 76, 109)" }}
                          >
                            -0.11%
                          </span>
                        </div>
                ...
                >
                  <a
                    href="https://www.sygnum.com/digital-asset-banking/ethereum-eth/"
                    className="link--absolute chart__coin-link"
                  >
                    <div className="chart__price">
                      <div className="chart__title-wrapper">
                ...
                >
                  <a
                    href="https://www.sygnum.com/digital-asset-banking/ripple-xrp/"
                    className="link--absolute chart__coin-link"
                  >
                    <div className="chart__price">
                      <div className="chart__title-wrapper">
                      ...
                      <div className="chart__price-wrapper">
                        ...
                        <div className="chart__change-wrapper">
                          <span
                            ...
                            style={{
                              background:
                                'url("/icons/price_change_up.svg") center center no-repeat',
                            }}
                          />
                          <span
                            className="chart__changes-percent--hour"
                            style={{ color: "rgb(64, 206, 121)" }}
                          >
                            0.20%
                          </span>
                        </div>
                ...
                >
                  <a
                    href="https://www.sygnum.com/digital-asset-banking/usd-coin-usdc/"
                    className="link--absolute chart__coin-link"
                  >
                    <div className="chart__price">
                      <div className="chart__title-wrapper">
                ...
                >
                  <a
                    href="https://www.sygnum.com/digital-asset-banking/cardano-ada/"
                    className="link--absolute chart__coin-link"
                  >
                    <div className="chart__price">
                      <div className="chart__title-wrapper">
                ...
                >
                  <a
                    href="https://www.sygnum.com/digital-asset-banking/solana/"
                    className="link--absolute chart__coin-link"
                  >
                    <div className="chart__price">
                      <div className="chart__title-wrapper">
                ...
                >
                  <a
                    href="https://www.sygnum.com/digital-asset-banking/polkadot/"
                    className="link--absolute chart__coin-link"
                  >
                    <div className="chart__price">
                      <div className="chart__title-wrapper">
                        <div className="chart__ico-wrapper">
                          <img
                            ...
                            width={24}
                            height={24}
                            src="https://assets.coingecko.com/coins/images/12171/small/polkadot.png?1696512008"
                            className="chart__ico wp-post-image"
                            alt=""
                          />{" "}
                        </div>
                ...
                >
                  <a
                    href="https://www.sygnum.com/digital-asset-banking/polygon-matic/"
                    className="link--absolute chart__coin-link"
                  >
                    <div className="chart__price">
                      <div className="chart__title-wrapper">
                        <div className="chart__ico-wrapper">
                          <img
                            ...
                            width={76}
                            height={76}
                            src="https://assets.coingecko.com/coins/images/4713/small/matic-token-icon.png?1696505277"
                            className="chart__ico wp-post-image"
                            alt="MATIC"
                          />{" "}
                        </div>
                ...
                >
                  <a
                    href="https://www.sygnum.com/digital-asset-banking/litecoin-ltc/"
                    className="link--absolute chart__coin-link"
                  >
                    <div className="chart__price">
                      <div className="chart__title-wrapper">
                        <div className="chart__ico-wrapper">
                          <img
                            ...
                            width={76}
                            height={76}
                            src="https://assets.coingecko.com/coins/images/2/small/litecoin.png?1696501400"
                            className="chart__ico wp-post-image"
                            alt="LTC"
                          />{" "}
                        </div>
                ...
                >
                  <a
                    href="https://www.sygnum.com/digital-asset-banking/bitcoin-cash-bch/"
                    className="link--absolute chart__coin-link"
                  >
                    <div className="chart__price">
                      <div className="chart__title-wrapper">
                        <div className="chart__ico-wrapper">
                          <img
                            ...
                            width={76}
                            height={76}
                            src="https://assets.coingecko.com/coins/images/780/small/bitcoin-cash-circle.png?1696501932"
                            className="chart__ico wp-post-image"
                            alt="BCH"
                          />{" "}
                        </div>
                        <div className="chart__title-inner">
                          <span className="chart__token-name">
                            Bitcoin Cash
                          </span>
                ...
                >
                  <a
                    href="https://www.sygnum.com/digital-asset-banking/digital-swiss-franc-dchf/"
                    className="link--absolute chart__coin-link"
                  >
                    <div className="chart__price">
                      <div className="chart__title-wrapper">
                        <div className="chart__ico-wrapper">
                          <img
                            ...
                            width={76}
                            height={76}
                            src="https://www.sygnum.com/wp-content/uploads/2022/02/DCHF.svg"
                            className="chart__ico wp-post-image"
                            alt="DCHF"
                          />{" "}
                        </div>
              ...
              <div className="chart-swiper__arrows-wrapper">
                <div className="chart-swiper__arrows">
                  <div className="swiper-button-prev chart-swiper__swiper-button-prev">
                    ...
                    >
                      ...
                      />
                      <path
                        d="M24.5234 28.8331L28.9934 33.3031L27.815 34.4814L21.3334 27.9998L27.815 21.5181L28.9934 22.6964L24.5234 27.1664L34.6667 27.1664L34.6667 28.8331L24.5234 28.8331Z"
                        fill="#737180"
                      />
                    </svg>
                  </div>
                ...
                <div className="chart__link-wrapper">
                  <a
                    href="https://www.sygnum.com/market-prices/"
                    className="link charts__link link--btn"
                  >
                    Go to market prices
                  </a>
                </div>
